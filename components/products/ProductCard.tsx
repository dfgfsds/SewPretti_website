        ...
        <div className="flex items-center justify-center mt-2">
          ...
          {product?.cartId ? (
            ...
            >
              ...
              <span className='border-2 px-10 border-red-400 text-red-900'>{product?.cartQty}</span>
            ...
            <button className="cursor-pointer relative px-4 py-1.5 bg-red-600 hover:bg-red-700 text-white group-hover:text-[#fff] font-semibold rounded-xl overflow-hidden group"
