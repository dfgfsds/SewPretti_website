    ...
    <>
      {data?.data?.length ? (
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg mb-3">
          ...
          <p className="mt-2 inline-block text-sm text-red-600 hover:text-red-700 cursor-pointer"
            onClick={() => {
          ...
          {!data?.data?.length ? (
            ...
            <>
              <Button className="w-full bg-red-600 hover:bg-red-700"
                ...
                disabled={!selectedAddressId || loading || !getPaymentDeliveryPartnerData?.data?.data[0]?.delivery_partner || CourierError}
              >
