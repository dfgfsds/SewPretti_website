      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {matchingProductsArray?.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-max  text-gray-800 animate-fadeIn">
            ...
            <button
              className="mt-8 px-6 py-3 bg-red-600 text-white rounded-full shadow-md hover:bg-red-700 transform transition hover:scale-105 animate-bounce"
              ...
              <div className="bg-[#F8F7F2] rounded-xl overflow-hidden">
                <div className="p-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Link href="/products" className="text-red-500 hover:underline text-sm flex items-center">
                      Continue Shopping
