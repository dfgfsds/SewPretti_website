          ...
          <div className="mb-14">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
              {subcategories.map((sub: any) => (
                <div
                  key={sub.id}
                  className="bg-red-300 shadow-sm rounded-lg overflow-hidden font-semibold cursor-pointer hover:shadow-md transition"
                  onClick={() =>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                {filteredProducts.map((p: any) => (
                  <div
                    ...
                    className="bg-red-300 border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition cursor-pointer"
                  >
                    <img
                      src={p.image_urls?.[0]}
                      alt={p.name}
