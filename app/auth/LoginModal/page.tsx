      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-96" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-6 flex justify-center">
          <div className="inline-flex rounded-full bg-gray-100 p-1 shadow-md">
            <button
              ...
              className={`px-4 py-1 rounded-full ${loginType === 'MOBILE' ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-200'}`}
            >
              Mobile Login
            </button>
            <button
              onClick={() => { setLoginType('EMAIL'); setStep('LOGIN'); setError(''); }}
              className={`px-4 py-1 rounded-full ${loginType === 'EMAIL' ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-200'}`}
            >
              Email Login
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center gap-2 py-2 px-4 rounded-md text-white bg-red-600 hover:bg-red-700"
          >
            {loginType === 'EMAIL'
              ? 'Login'
              : step === 'LOGIN'
