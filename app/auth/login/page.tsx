        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      className="pl-10 block w-full border-2 rounded-md border-gray-300 focus:border-yellow-500 focus:ring-yellow-500"
                    />
                  </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex gap-2 justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700"
            >
              {loginType === 'EMAIL'
                ? 'Login'
                : step === 'LOGIN'
            ...
            <p className="text-sm text-center text-gray-500">
              ...
              <Link href="/auth/register" className="text-red-600 hover:text-red-700 font-medium">Register</Link>
            </p>
          </form>
        </div>
      </div>
