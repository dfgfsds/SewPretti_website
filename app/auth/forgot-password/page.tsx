    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 p-2">
      ...
      {!showPasswordReset && (
        <form onSubmit={handleEmailSubmit} className="space-y-5">
            ...
            <div className="mt-1 relative">
              ...
              <input
                ...
                className={`pl-10 block w-full rounded-md border ${errorMessage ? 'border-red-500' : 'border-gray-300'
                  } shadow-sm focus:border-blue-500 focus:ring-red-500 ${emailLoader ? 'cursor-not-allowed bg-gray-100' : ''
                  }`}
              />
          ...
          <button
            type="submit"
            className="w-full gap-2 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            disabled={emailLoader}
          >
            ...
            <div className="flex justify-center gap-2 mb-4">
              {otp.map((val, idx) => (
                <input
                  ...
                  className="w-10 h-12 text-center border border-gray-300 rounded focus:ring-2 focus:ring-red-500"
                />
              ))}
            </div>
      ...
      {showPasswordReset && (
        <form onSubmit={handlePasswordReset} className="space-y-5 mt-6">
          ...
          <button
            type="submit"
            className="w-full bg-red-600 text-white py-2 rounded-md hover:bg-red-700 disabled:cursor-not-allowed"
